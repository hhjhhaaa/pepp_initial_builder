...
from pepp_initial_builder.mlff_seed.lammps_relax import collect_lammps_relax_manifests, write_lammps_relax_inputs
...
def collect_lammps_relax_main(argv: Sequence[str] | None = None) -> None:
    args = _parser().parse_args(argv)
    print(collect_lammps_relax_manifests(load_pore_config(config_path(args.config))))
