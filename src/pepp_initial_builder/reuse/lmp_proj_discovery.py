    ...
    files_not_reused_and_reason = [
        {
            ...
            "reason": "Patch extraction is discovered, but the public extractor requires a Ru/metal ClusterSelection and SurfacePatchContext from the old placement pipeline; PE/PP-silica AIMD local structures do not currently provide that contract. Keep as reference only until a PE/PP-silica contract is defined.",
        },
        {
            "file": "/home/jinhao/lmp-proj/Mesoporous_structure_generation/microcal/cp2k/prepare.py",
            "reason": "CP2K input writer is GEO_OPT/Ru-catalyst oriented. The current workflow needs ENERGY_FORCE and short NVT AIMD for C/H/O/Si systems, so this module is referenced for conventions but not imported at runtime.",
        },
    ]
    report = {
        ...
        "recommended_reuse_strategy": "Review lmp-proj implementations and cleanly reimplement the needed CP2K/HPC/parser behavior inside pepp_initial_builder. Do not copy the old project and do not add runtime imports.",
